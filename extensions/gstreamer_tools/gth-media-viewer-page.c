		    ...
		    GstState            new_state)
{
	if (! self->priv->playing && (new_state == GST_STATE_PLAYING)) {
		...
		gtk_image_set_from_icon_name (GTK_IMAGE (GET_WIDGET ("play_button_image")), "xsi-media-playback-pause-symbolic", GTK_ICON_SIZE_LARGE_TOOLBAR);
